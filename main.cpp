    ...
    while (msg.message != WM_QUIT && !LoginCheck)
    {
        ...
        ImGui::NewFrame();
        {
            ...
            ImGui::Begin("Lucent.vip", &loader_active, window_flags);
            {
                ...
                //Your code will go here you will have to create a window
                ...
                if (InfWindow == true) {
...

                    {
                        ...
                        ImGui::Begin(LOADER_BRAND, &loader_active, window_flags);
                        {
                            ...
                            //ALL YOUR MAIN CODE WILL GO HERE
                            //You can put it tabs or not just delete all the tab things and it will just be a plain window
